...
This project has been transformed from a personal configuration into a **publishable, open-source template** for automated Let's Encrypt certificate generation using GitHub Actions with multi-provider DNS-01 validation.
...
### Updated Files
- `.github/workflows/certificate.yml` — Generic workflow with multi-provider support
- `scripts/generate-cert.sh` — Updated for multiple DNS providers
...
2. Configure GitHub Secrets for your DNS provider
3. Configure GitHub Variables (domains, email, provider)
4. Run the workflow
